                    ...
                    <div class="about-block">
                        ...
                        <div class="row">
                            ...
                            while ( have_posts() ) : the_post(); ?> <!--Because the_content() works only inside a WP Loop -->
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="left"><a style="display: inline" href="<?php echo get_home_url()?>" class="btn btn-dark btn-block ">Tiếp tục mua hàng</a></td>
                                        <td align="right"><a style="display: inline" href="<?php echo edd_get_checkout_uri(); ?>" class="btn btn-dark btn-block">Thanh toán</a></td>
                                    </tr>
                                </table>
